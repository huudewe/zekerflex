...
export default function VerifyPage() {
  return <Suspense fallback={<main className="flex min-h-screen items-center justify-center bg-slate-50 px-6 py-12"><div className="w-full max-w-md rounded-3xl border border-gray-100 bg-white p-8 text-center text-sm text-gray-500 shadow-xl">Pagina laden...</div></main>}><VerifyForm /></Suspense>;
}
